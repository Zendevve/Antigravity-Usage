...
function registerCommands(context: vscode.ExtensionContext) {
  const commands = [
    ...
    },
    {
      ...
      handler: () => {
        // Focus the sidebar view container
        // Note: The ID follows the pattern workbench.view.extension.<viewContainerId>
        vscode.commands.executeCommand('workbench.view.extension.antigravity-usage-container');
      }
    },
    {
